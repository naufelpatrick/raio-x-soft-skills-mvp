...
function layout({ preheader, greetingText, paragraphs, ctaLabel, ctaUrl, unsubscribeUrl }) {
  ...
  const unsubscribe = unsubscribeUrl
    ...
    : "";
  const brandHeader = `<img src="${SITE_URL}/raio-x-logo-email.png" width="260" height="76" alt="Raio X do Designer" style="display:block;width:260px;max-width:100%;height:auto;border:0;color:#ffffff;font-size:20px;font-weight:700">`;
